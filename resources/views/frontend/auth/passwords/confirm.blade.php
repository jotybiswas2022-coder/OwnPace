...
<style>
/* ============================================================
   {{ storeName() }} — Confirm Password (matches Sign In)
...
<div class="cc-stage">
    ...
    <div class="cc-card">
        ...
        <header class="cc-head">
            <span class="cc-mark"><i class="bi bi-shield-fill-check"></i></span>
        ...
        <form method="POST" action="{{ route('password.confirm') }}" class="cc-form" id="cpForm">
            @csrf
            ...
            <div class="cc-field">
                ...
                <div class="cc-input-wrap">
                    <input id="password" type="password" name="password"
                        ...
                        required autocomplete="current-password" autofocus spellcheck="false">
                    <button type="button" class="cc-toggle" id="cpToggle" aria-label="Show password">
            ...
            <button type="submit" class="cc-btn" id="cpBtn">
        ...
        <div class="cc-register">
            ...
            <a href="{{ route('password.request') }}"><i class="bi bi-key-fill"></i> Reset it</a>
        </div>
        @endif
