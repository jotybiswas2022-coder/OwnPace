...
<style>
/* ============================================================
   {{ storeName() }} — Verify Email (matches Sign In)
...
<div class="cc-stage">
    ...
    <div class="cc-card">
        ...
        <header class="cc-head">
            <span class="cc-mark"><i class="bi bi-envelope-check-fill"></i></span>
        ...
        <form method="POST" action="{{ route('verification.resend') }}" class="cc-form" id="vfForm">
            @csrf
            <button type="submit" class="cc-btn" id="vfBtn">
