...
<style>
/* ============================================================
   {{ storeName() }} — Create Account (matches Sign In)
...
/* Agree terms row (register) */
.cc-agree{
    width: 100%; max-width: 18.5rem; align-items: flex-start; justify-content: flex-start;
    text-align: left; font-size: 0.78rem; line-height: 1.5; margin-top: 0.1rem;
}
.cc-agree .cc-check-box{ margin-top: 0.15rem; }
.cc-agree a{ color: var(--cc-gold-2); text-decoration: underline; text-underline-offset: 2px; transition: color 0.18s ease; }
.cc-agree a:hover{ color: var(--cc-gold); }
...
@media (max-width: 680px){
    ...
    .cc-form{ gap: 0.75rem; }
    .cc-field, .cc-btn, .cc-agree{ max-width: min(17rem, 100%); width: 100%; margin-inline: auto; }
...
<div class="cc-stage">
    ...
    <div class="cc-card">
        ...
        <header class="cc-head">
            <span class="cc-mark"><i class="bi bi-person-plus-fill"></i></span>
            <h2>Create <span>Account</span></h2>
            <p>Join {{ storeName() }} — sign up in seconds.</p>
        </header>
        ...
        <form method="POST" action="{{ route('register') }}" class="cc-form" id="rcForm">
            @csrf
            ...
            <div class="cc-field">
                ...
                <div class="cc-input-wrap">
                    ...
                    <button type="button" class="cc-toggle" id="rcToggle" aria-label="Show password">
                        <i class="bi bi-eye" id="rcIcon"></i>
                    </button>
                </div>
                <span class="cc-hint"><i class="bi bi-info-circle-fill"></i> At least 8 characters</span>
                @error('password')
                    <p class="cc-error"><i class="bi bi-info-circle-fill"></i> {{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="cc-field">
                <label for="password-confirm" class="cc-label">Confirm password</label>
                <div class="cc-input-wrap">
                    <input id="password-confirm" type="password" name="password_confirmation"
                        class="cc-input cc-input-has-toggle"
                        placeholder="Re-enter password" required autocomplete="new-password" spellcheck="false">
                    <button type="button" class="cc-toggle" id="rcToggle2" aria-label="Show password">
                        <i class="bi bi-eye" id="rcIcon2"></i>
                    </button>
                </div>
            </div>

            <label class="cc-check cc-agree" for="agreeTerms">
                <input type="checkbox" name="agree_terms" id="agreeTerms" value="1" required>
                <span class="cc-check-box"><i class="bi bi-check-lg"></i></span>
                <span>I agree to the <a href="{{ url('/terms') }}" target="_blank">Terms &amp; Conditions</a> and <a href="{{ url('/terms/privacy') }}" target="_blank">Privacy Policy</a></span>
            </label>

            <button type="submit" class="cc-btn" id="rcBtn">
...
(function () {
    var toggles = [
        ['rcToggle', 'password', 'rcIcon'],
        ['rcToggle2', 'password-confirm', 'rcIcon2']
    ];
